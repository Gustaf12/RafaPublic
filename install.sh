...
check_token() {
  ...
  if [ "$USER_TOKEN" = "ayangamaliasyva" ]; then
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer RafatharCode   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : RafatharCode      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : RafatharCode  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by RafatharCode  ${NC}"
